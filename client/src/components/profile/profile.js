        ...
        <div className="btn btn-primary btn-sm follow" onClick={()=>navigate("/updateprofile")}>update profile</div>
            <div class=" justify-content-between align-items-center mt-4 px-4">
                ...
                <h6 class="mb-0 txt">Name: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.name : <p class="pd">Name</p>}</h6>
                </div>
                <div class="d-flex justify-content-between align-items-center mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">Date of Birth: </h6>

                    <h6 class="mb-0 txt">{profiledata ? profiledata.dateofbirth : <p>Date of Birth</p>}</h6> 
                </div>
                <div class="d-flex justify-content-between align-items-center mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">Phone: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.phone : <p>Phone</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">No. of covid doses taken: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.doses : <p>No. of covid doses taken:</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">Married: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.married : <p>Married</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between  mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">No. of kids: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kids : <p>No. of kids</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between  mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">Age of kids: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidsage : <p>Age of kids</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">Family fully vaccinated for covid: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.familyvaccinated : <p>Family fully vaccinated for covid ?</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">All kids polio vaccinated: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidspolio : <p>All kids polio vaccinated</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">All kids Tetanus vaccinated: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidstetanus : <p>All kids Tetanus vaccinated</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">All kids Chickenpox vaccinated: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidschickenpox : <p>All kids Chickenpox vaccinated</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">All kids Tuberculosis vaccinated: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidstb : <p>All kids Tuberculosis vaccinated</p>}</h6> 
                </div>

                <div class="d-flex justify-content-between mt-4 px-4 stats">
                
                <h6 class="mb-0 txt">All kids Pneumonia vaccinated: </h6>
                    <h6 class="mb-0 txt">{profiledata ? profiledata.kidspneumonia : <p>All kids Pneumonia vaccinated</p>}</h6> 
                </div>
            </div>
        </div>
    </div>
