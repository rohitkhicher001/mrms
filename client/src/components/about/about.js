...
const About = () => {
    ...
    return (
        <div className="about">
            ...
            <div className="aboutpage lead">
                <div>
                    <div className="lead">Vaccination against a range of bacterial and viral diseases is an integral part of communicable disease control worldwide. Vaccination against a specific disease not only reduces the incidence of that disease, it reduces the social and economic burden of the disease on communities. Very high immunisation coverage can lead to complete blocking of transmission for many vaccine preventable diseases (VPD). It is always better to prevent a disease than to treat it after it occurs. For ex. the worldwide eradication of smallpox and the near eradication of polio from many countries provide excellent examples of the role of immunisation in disease control.</div>

                    <div className="lead">Early immunisation of infants and completion of the full schedule of vaccinations up to and through adulthood contributes to reducing the incidence and burden of vaccine preventable diseases.</div>
                    <div className="lead">Immunity is the body’s way of preventing disease. When a baby is born, his/her immune system is not fully developed, which can put him/her at greater risk for infections. Vaccines reduce a child’s risk of infection by working with his/her body’s natural defences to help safely develop immunity to disease.</div>
                    <div className="lead">Mild side effects are expected</div>
                    <div className="lead">Like any medicine, vaccines can cause side effects such as a low-grade fever, or pain and redness at injection site. Mild reactions go away within a few days on their own.</div>
                    <div className="lead">Severe, long lasting side effects are extremely rare.</div>
                </div>
                <br></br>
                <div className="aboutpage lead"><b>Common Vaccine preventable diseases:</b></div>
                ...
                <div className="aboutpage lead"> 
                    ...
                    <div>Ref- </div>
                    <a href="https://www.cdc.gov/vaccines/parents/diseases/forgot-14-diseases.html">https://www.cdc.gov/vaccines/parents/diseases/forgot-14-diseases.html</a>
                    <br/>
                    <a href="https://www.unicef.org/parenting/health/vaccines-and-diseases-they-prevent">https://www.unicef.org/parenting/health/vaccines-and-diseases-they-prevent</a>
